...
// --- Lib ---
import { isMarkInSchema, isNodeTypeSelected } from '@/shared/lib/tiptap'
// --- Icons ---
import { BoldIcon } from '@/shared/ui/tiptap/icons/bold-icon'
import { Code2Icon } from '@/shared/ui/tiptap/icons/code2-icon'
import { ItalicIcon } from '@/shared/ui/tiptap/icons/italic-icon'
import { StrikeIcon } from '@/shared/ui/tiptap/icons/strike-icon'
import { SubscriptIcon } from '@/shared/ui/tiptap/icons/subscript-icon'
import { SuperscriptIcon } from '@/shared/ui/tiptap/icons/superscript-icon'
import { UnderlineIcon } from '@/shared/ui/tiptap/icons/underline-icon'
